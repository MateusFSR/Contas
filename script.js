...
// ===== EXPANDIR DASHBOARD =====
function expandirDashboard(el) {
  el.classList.toggle("dashboard-expandido");
}
...
let evolucao = [1200,1500,1800,2100,2400,2600,2900,3000,3200,3400,3600,3800];
...
new Chart(document.getElementById("graficoLimite"),{
